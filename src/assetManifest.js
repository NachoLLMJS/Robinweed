export const ASSET_URLS = Object.freeze({
  ...
  dressing: Object.freeze({
    bin: '/models-v40/dressing/bin.glb',
    bags: '/models-v40/dressing/bags.glb',
    crates: '/models-v40/dressing/crates.glb',
    hydrant: '/models-v40/dressing/hydrant.glb',
    mailbox: '/models-v40/dressing/mailbox.glb',
    sign: '/models-v40/dressing/sign.glb',
    bench: '/models-v40/dressing/bench.glb',
    bike: '/models-v40/dressing/bike.glb',
    planter: '/models-v40/dressing/planter.glb',
    litterbin: '/models-v40/dressing/litterbin.glb',
    sedan: '/models-v40/dressing/sedan.glb',
    hatchback: '/models-v40/dressing/hatchback.glb',
    pickup: '/models-v40/dressing/pickup.glb',
    wall: '/models-v40/dressing/wall.glb',
    hedge: '/models-v40/dressing/hedge.glb',
    hedgeShort: '/models-v40/dressing/hedge-short.glb',
    garage: '/models-v40/dressing/garage.glb',
    shed: '/models-v40/dressing/shed.glb',
  }),
});
