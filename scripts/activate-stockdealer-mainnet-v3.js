...
const FOUNDATION_PATH = resolve('deployments/robinhood-mainnet-foundation-v3.json');
const SAFE_BATCH_PATH = resolve('deployments/safe-activation-v3-batch.json');
...
async function main(){
  ...
  if(foundation.chainId!==CHAIN_ID||foundation.status!=='FOUNDATION_V3_DEPLOYED_PAUSED_TOKEN_UNCONFIGURED'||!foundation.codeHashes)throw new Error('FOUNDATION_NOT_VERIFIABLE');
