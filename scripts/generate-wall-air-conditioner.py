...
REFERENCE_DIR = ROOT / "artifacts" / "meshy" / "wall-air-conditioner" / "references"
JOURNAL_DIR = ROOT / "artifacts" / "meshy" / "wall-air-conditioner" / "journals"
OUTPUT_DIR = ROOT / "public" / "models-v34" / "warehouse"
BASE_URL = "https://api.meshy.ai/openapi/v1"
TERMINAL = {"SUCCEEDED", "FAILED", "CANCELED", "EXPIRED"}
ASSETS = {"wall-air-conditioner": "wall-air-conditioner.png"}
